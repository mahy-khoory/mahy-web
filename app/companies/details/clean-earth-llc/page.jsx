        ...
        <main>
            ...
            <WhyUs
                items={{
                    ...
                    data: [
                        { title: "Mision", content: "Clean Earth LLC’s mission is to deliver reliable, compliant, and environmentally responsible waste collection and recycling services that help businesses reduce environmental impact and meet regulatory obligations." },
                        { title: "Vision", content: "Its vision is to contribute to a cleaner, more sustainable urban environment by promoting responsible waste handling practices and supporting the transition toward a circular economy across the UAE." }
                    ]
                }}
            />
            <SolarPanelImageGrid
                ...
                items={[
                    { title: "Reusable Industrial Oil Collection", text: "Safe collection and recovery of used lubricants and industrial oils for re-refining or approved recycling processes." },
                    { title: "Used Cooking Oil Collection", text: "Scheduled pickup services for hotels, restaurants, catering facilities, and commercial kitchens, ensuring responsible handling and recycling of cooking oils." },
                    { title: "Metal and Iron Scrap Recovery", text: "Collection, segregation, and supply of ferrous and non-ferrous metal scrap to authorized recycling markets." },
                    { title: "Glass Scrap Collection", text: "Handling and transportation of broken and reusable glass for processing into recycled cullet and new glass products." },
                ]}
            />
            <section className="max-w-7xl mx-auto px-5 py-15 md:pt-25">
                <CompaniesSectors
                    ...
                    text2={"This structured approach ensures regulatory compliance while maintaining operational efficiency."}
                />
            </section>
            <TrustedAdvisorSection
                heading="Market Focus"
                texts={[
                    "Clean Earth LLC serves a diverse client base, including:",
                ]}
                bullets={[
            ...
            <section className="max-w-7xl mx-auto px-5 py-15 md:pt-25">
                <CompaniesSectors
                    ...
                    text2={"By combining operational reliability with environmental expertise, Clean Earth LLC acts as a trusted partner for sustainable waste management."}
                />
            </section>
        </main>
    )
