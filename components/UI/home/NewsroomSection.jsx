...
function NewsroomSection({ articles, locale }) {
    return (
        <section className='max-w-7xl mx-auto pt-10 lg:pt-35 px-5'>
            ...
            <div className='border-t border-gray-200 grid grid-cols-1 lg:grid-cols-2'>
                <Link href={`/news/${articles[0].id}`}>
                    <div className='pt-8 lg:pr-8 border-b lg:border-b-0 pb-8 lg:pb-0 lg:border-r lg:h-full border-gray-200'>
                ...
                <div className='lg:pl-8'>
                    {Array.from({ length: 3 }).map((_, i) => (
                        <Link href={`/news/${articles[i + 1].id}`} key={i}>
                            <div className='flex justify-between py-8 border-b border-gray-200' >
