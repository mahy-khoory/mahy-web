...
const projects = [
    { id: 1, name: "Cape Hayat Four Apartment Buildings", location: "Ras Al Khaimah", sector: "Luxury Residential", developer: "RAK Properties", scale: "Mega Project" },
    { id: 2, name: "Falcon Island Villas Development", location: "Ras Al Khaimah", sector: "Luxury Residential", developer: "Al Hamra Real Estate", scale: "Mega Project" },
    { id: 3, name: "Marbella Villa Extension Project (89 Villas, Mina Al Arab)", location: "Ras Al Khaimah", sector: "Residential", developer: "RAK Properties", scale: "Medium" },
    { id: 4, name: "G+M+8+R Residential & Commercial Building - Al Rigga, Dubai", location: "Dubai", sector: "Mixed-Use", developer: "Al Wasl Properties", scale: "Medium" },
    { id: 5, name: "G+14 Mixed-Use Building - Al Furjan, Dubai", location: "Dubai", sector: "Mixed-Use", developer: "ASF Real Estate", scale: "Large" },
    { id: 6, name: "Sunreef Yacht Manufacturing Facility - Dubai", location: "Dubai", sector: "Industrial", developer: "Sunreef Yachts", scale: "Large" },
    { id: 7, name: "Paradise Hills - 170 Luxury Villas, Dubai", location: "Dubai", sector: "Luxury Residential", developer: "Gulf Land Properties", scale: "Large" },
    { id: 8, name: "Nursery Building - Jumeirah Village Circle, Dubai", location: "Dubai", sector: "Education", developer: "Not specified", scale: "Small" },
    { id: 9, name: "364 Reem Townhouses - Nshama, Town Square Dubai", location: "Dubai", sector: "Residential", developer: "Nshama", scale: "Large" },
    { id: 10, name: "Serbia Pavilion - Expo 2020 Dubai", location: "Dubai", sector: "Exhibition", developer: "Not specified", scale: "Mega Project" },
    { id: 11, name: "Gardenia Living - Near Miracle Garden, Dubai", location: "Dubai", sector: "Residential", developer: "Not specified", scale: "Medium" },
    { id: 12, name: "The Place Business Chamber - Dubai Chambers", location: "Dubai", sector: "Commercial", developer: "Dubai Chambers", scale: "Small" },
    { id: 13, name: "Emirates Golf Estate Villas - Dubai", location: "Dubai", sector: "Luxury Residential", developer: "Not specified", scale: "Medium" },
    { id: 14, name: "Sobha Construction - Chilled Water Pump Supply", location: "UAE", sector: "Infrastructure", developer: "Sobha Construction", scale: "Medium" },
    { id: 15, name: "District Cooling Plant - AG Engineering", location: "UAE", sector: "District Cooling", developer: "AG Engineering", scale: "Large" },
    { id: 16, name: "Sobha District Cooling Plant - UAE", location: "UAE", sector: "District Cooling", developer: "Sobha Construction", scale: "Medium" },
    { id: 17, name: "Maimoon Gardens - Jumeirah Village Circle (JVC), Dubai", location: "Dubai", sector: "Residential", developer: "Not specified", scale: "Large" },
    { id: 18, name: "JW Marriott Refurbishment - Dubai, UAE", location: "Dubai", sector: "Hospitality", developer: "Not specified", scale: "Small" },
    { id: 19, name: "Hayyan Villas - Alef Group, Sharjah, UAE", location: "Sharjah", sector: "Residential", developer: "Alef Group", scale: "Medium" },
    { id: 20, name: "Burj Binghatti - Business Bay, Dubai", location: "Dubai", sector: "Mixed-Use", developer: "Not specified", scale: "Mega Project" },
    { id: 21, name: "Expo City Dubai - UAE", location: "UAE", sector: "Infrastructure", developer: "Not specified", scale: "Mega Project" },
    { id: 22, name: "Dubai Design District (d3) - Dubai, UAE", location: "Dubai", sector: "Mixed-Use", developer: "TECOM Group", scale: "Mega Project" },
    { id: 23, name: "Symbolic Aura - Al Furjan, Dubai", location: "Dubai", sector: "Residential", developer: "Symbolic Developments", scale: "Medium" },
    { id: 24, name: "DAMAC Canal Crown 1 & 2 - Business Bay, Dubai", location: "Dubai", sector: "Luxury Residential", developer: "DAMAC Properties", scale: "Mega Project" }
];
